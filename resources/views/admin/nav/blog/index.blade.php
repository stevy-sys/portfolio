@extends('layouts.admin.paneladmin',['title' => 'Toutes les articles'])
        ...
        @foreach ($blog as $item)
            <div class="col-lg-4">
              <div class="card shadow-sm">
                <img src="{{ environement() ? asset('storage/'.$item->img) :  secure_asset('storage/'.$item->img) }}" height="200vh" class="img-responsive" alt="HTML5 Bootstrap Template by colorlib.com">
                <h3>{{$item->titre}}</h3>
                <div class="card-body">
